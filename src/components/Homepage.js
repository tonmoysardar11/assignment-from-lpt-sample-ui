...
const Homepage = () => {
  return (
    <div className="h-[100vh] w-[100vw] grid grid-cols-12 grid-rows-9 lg:gap-x-10">
      <div className="grid col-span-12 row-span-1 lg:col-span-1 lg:row-span-9">
        <Navbar />
      </div>
      <div className="grid col-span-12 row-span-4 lg:col-span-11 row-span-4"><MusicTheory/></div>
